...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Define copyManualScript function globally
    window.copyManualScript = function() {
        const textarea = document.querySelector('.script-container textarea');
        if (textarea) {
            textarea.select();
            ...
            try {
                ...
                const btn = document.querySelector('.script-container .btn');
